import LateralLeastSquares as lls
...
if __name__ == '__main__':
    ...
    resp_2l_2r = dp.fromAlvolo(resp_2l_2r)
    ...
    resp_l_r = dp.fromAlvolo(resp_l_r)
    ...
    resp_r_l = dp.fromAlvolo(resp_r_l)
